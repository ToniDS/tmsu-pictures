...
with open('/dev/stdout', 'w') as line: #bad workaround, refactor to sys.stdout.write() without "with open"
...
#write a file with each picture path and the time difference we need to change.
            ...
            if date(2018,3,15) == date_object:
                    ...
                    # Only those with "00" in between are from Dubai, and therefore 3 hours td
